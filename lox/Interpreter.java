...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    Interpreter() {
        // Define some built-in functions in the global environment
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        environment.define(stmt.name.lexeme, null); // Define class in the environment

        if(stmt.superclass != null) {
            // Create a new environment for the class scope
            environment = new Environment(environment);
            environment.define("super", superclass); // Define 'super' in the class scope
        }
    ...
    public Void visitReturnStmt(Stmt.Return stmt) {
        ...
        throw new Return(value); // Custom exception to handle return values
    }
